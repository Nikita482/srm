...
что менять:
// доаботать коменты - уделение коментов, редактирования зп (salary в бд)
// доработать дизайн
// мб прикрутить фильтр к селекту выбора месяца
// добавить к зп провайдер где будет поле для редактирования и кнопка с фикс зп
// редактирование дней недели плывет на маленьком экране при большом колличестве дней
